...
| `ferrodoc-markdown` pandoc-markdown reader | **3/3** on the fixtures written for it, **11/20** over every markdown document in `corpus/`, and **496/652** over the CommonMark spec — which is why `-f markdown` is still CommonMark here |
