...
[.line-through]#Struck-through text[.line-through]# and text with a footnote.footnote:[Footnote bodies can contain *formatting* and a https://example.com[link].]

A link with a title: https://example.com/spec[the spec].
A bare autolink: https://example.com/status[https://example.com/status]. An email:
mailto:ops@example.com[ops@example.com].

An image: image:logo.png[the logo]
...
Contact mailto:ops@example.com[ops@example.com] with questions. See the `LICENSE` file for
terms.
