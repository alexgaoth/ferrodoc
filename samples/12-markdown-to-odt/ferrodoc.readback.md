# <span id="anchor"></span>Field Handbook
...
## <span id="anchor"></span>Why this exists
...
## <span id="anchor"></span>Rollout schedule
...
## <span id="anchor"></span>What each team has to do
...
### <span id="anchor"></span>Checklist

- [x] Inventory complete
- [ ] Pilot signed off
- [ ] Rollback plan written

## <span id="anchor"></span>Running a conversion
...
## <span id="anchor"></span>Awkward cases, on purpose

Inline code with special characters: `a | b`, `<div>`, `--flag`, and a literal backtick: `` ` ``.
